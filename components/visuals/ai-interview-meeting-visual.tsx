...
export default function AIInterviewMeetingVisual({
  ...
  const colors = {
    ...
    skyBlue: { pale: "#E0F2FE", bright: "#38BDF8", deep: "#0284C7", darkText: "#0C4A6E" },
      ...
      >
        <defs>
          ...
          <filter id="crystalShadow" x="-20%" y="-20%" width="140%" height="140%">
            <feDropShadow dx="0" dy="2" stdDeviation="3" floodColor={colors.skyBlue.darkText} floodOpacity="0.15" />
          </filter>
        </defs>
        ...
        >
          ...
          <rect 
            x="35" y="35" width="160" height="110" rx="16" 
            fill="#FFFFFF" fillOpacity="0.3"
            stroke="url(#crystalEdge)" strokeWidth="1.5"
          ...
          {/* Crystal Label Pill */}
          <rect x="45" y="125" width="40" height="14" rx="7" fill="#FFFFFF" fillOpacity="0.5" stroke="url(#crystalEdge)" strokeWidth="0.5" />
          <text x="65" y="135" textAnchor="middle" fill={colors.skyBlue.deep} fontSize="8" fontWeight="700" letterSpacing="0.5">AI SPEAKING</text>
        </motion.g>
        ...
        >
           {/* Crystal Video Container */}
           <rect 
             x="205" y="35" width="160" height="110" rx="16" 
             fill="#FFFFFF" fillOpacity="0.3" 
             stroke="url(#crystalEdge)" strokeWidth="1.5"
             filter="url(#crystalShadow)"
            />
           ...
           <g transform="translate(285, 90)">
             ...
             <path d="M -22 15 Q 0 25 22 15 V 25 H -22 Z" fill="url(#userGradient)" opacity="0.8" />
             <path d="M -22 15 Q 0 -5 22 15" fill="url(#userGradient)" />
           </g>

           {/* Crystal Label Pill */}
           <rect x="325" y="125" width="30" height="14" rx="7" fill="#FFFFFF" fillOpacity="0.5" stroke="url(#crystalEdge)" strokeWidth="0.5" />
           <text x="340" y="135" textAnchor="middle" fill={colors.skyBlue.deep} fontSize="8" fontWeight="700" letterSpacing="0.5">YOU</text>
        </motion.g>
        ...
        >
          {/* Crystal Background */}
          <rect 
            x="35" y="160" width="330" height="65" rx="16" 
            fill="#FFFFFF" fillOpacity="0.4"
            stroke="url(#crystalEdge)" strokeWidth="2"
            filter="url(#crystalShadow)"
          />
          
          <text x="200" y="182" textAnchor="middle" fill={colors.skyBlue.darkText} fontSize="12" fontWeight="700">
            Tell me about your experience
          </text>
          <text x="200" y="198" textAnchor="middle" fill={colors.skyBlue.deep} fontSize="10" fontWeight="500">
        ...
        >
          ...
          <rect 
            x="80" y="245" width="240" height="40" rx="20" 
            fill="#FFFFFF" fillOpacity="0.4"
            stroke="url(#crystalEdge)" strokeWidth="1.5"
            filter="url(#crystalShadow)"
          />
          ...
          <g transform="translate(120, 265)">
             ...
             <rect x="-3" y="-4" width="6" height="8" rx="3" fill={colors.skyBlue.deep} />
             
             {/* Camera (Active) */}
             <g transform="translate(40, 0)">
                <circle cx="0" cy="0" r="12" fill={colors.skyBlue.pale} />
                <rect x="-5" y="-3" width="10" height="6" rx="1" fill={colors.skyBlue.deep} />
             </g>

             {/* End Call - Deep Orange */}
             <g transform="translate(80, 0)">
                <circle cx="0" cy="0" r="12" fill={colors.orange.deep} /> 
                <rect x="-4" y="-1.5" width="8" height="3" rx="1.5" fill="#FFFFFF" />
             </g>
             
             {/* Menu */}
             <g transform="translate(120, 0)">
                <circle cx="0" cy="0" r="12" fill="transparent" stroke={colors.skyBlue.pale} strokeWidth="1" />
