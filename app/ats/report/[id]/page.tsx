  ...
  return (
    <div className="min-h-screen bg-[#F9F7F3]">
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className={`hidden lg:flex shrink-0 transition-all duration-300 ${messages.length > 0 ? "w-80" : "w-56"}`}>
          <div className={`bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-col sticky top-24 w-full transition-all duration-300`} style={{ height: messages.length > 0 ? "min(500px, calc(100vh - 8rem))" : "300px" }}>
