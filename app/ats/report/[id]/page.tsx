  ...
  return (
    <div className="min-h-screen bg-[#F9F7F3]">
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="hidden lg:flex w-48 shrink-0">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 flex flex-col sticky top-24 w-full" style={{ height: "280px" }}>
